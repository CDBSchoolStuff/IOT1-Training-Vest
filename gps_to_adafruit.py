...
send_freq = 30                             # Tid mellem at opdateret information sendes til Adafruit.
...
def gps_to_adafruit_thread():
    while True:
        try:
            ...
            sleep(send_freq) # vent mere end 3 sekunder mellem hver besked der sendes til adafruit
